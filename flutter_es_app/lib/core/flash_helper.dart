      ...
      builder: (context, controller) {
        return Flash(
          ...
          child: FlashBar(
            ...
            message: SelectableText(message,
                style: _contentStyle(context, Colors.white)),
          ...
          builder: (context, setState) {
            return Flash.dialog(
              ...
              child: FlashBar(
                title: title == null
                    ? null
                    : SelectableText(title, style: _titleStyle(context)),
                message: SelectableText(message,
      ...
      builder: (context, controller) {
        ...
        return Flash<String>.bar(
          ...
          child: FlashBar(
            title: title == null
                ? null
                : SelectableText(title, style: const TextStyle(fontSize: 24.0)),
            message: Column(
              children: [
